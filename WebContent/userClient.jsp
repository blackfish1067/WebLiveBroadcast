					...
					<div class="col-md-8 latest-news-agile-left-content">
						...
						<div class="single video_agile_player">
							...
							<div style="float: center">
								<img id="receiver" style="width: 320px; height: 240px" /> <br>
								<br>空白表示当前不在视频直播，
								...
								function connect(){
									receiver_socket = new WebSocket("ws://"
											+ document.domain
											+ ":8080/WebLiveBroadcast/liveServer/"+room);
									image = document.getElementById('receiver');
									receiver_socket.onmessage = live;
								}
